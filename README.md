...
From above, the default convention ensures the primary key attribute is included by default. To prevent this behavior,  set **excludePK** option in the schema to **false** . 
...
| **emptyPolicy** | Defines the policy that is used when a field is not available or found during serialization. Possible values include **SET_NULL**, **SET_UNDEFINED** and **IGNORE**  |
